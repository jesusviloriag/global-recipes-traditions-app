            ...
            <tbody>
              {likeList.map((like, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{like.recipe ? <Link to={`/recipe/${like.recipe.id}`}>{like.recipe.title}</Link> : ''}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/like/${like.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        tag={Link}
                        to={`/like/${like.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
